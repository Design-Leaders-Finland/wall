...
void main() {
  group('Main App Tests', () {
    ...
    testWidgets('MyApp should have correct app configuration', (
      WidgetTester tester,
    ) async {
      await tester.pumpWidget(const MyApp());
    ...
    testWidgets('should have light theme with blue color scheme', (
      WidgetTester tester,
    ) async {
      await tester.pumpWidget(const MyApp());
    ...
    testWidgets('should have dark theme with blue color scheme', (
      WidgetTester tester,
    ) async {
      await tester.pumpWidget(const MyApp());
    ...
    group('Widget Structure', () {
      testWidgets('MyApp should contain MaterialApp', (
        WidgetTester tester,
      ) async {
        await tester.pumpWidget(const MyApp());
    ...
    group('App Initialization', () {
      testWidgets('should handle MyApp creation without errors', (
        WidgetTester tester,
      ) async {
