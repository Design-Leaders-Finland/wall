...
class _MessageInputState extends State<MessageInput> {
  ...
  void _handleSend() {
    ...
    if (messageContent.isNotEmpty && messageContent.length <= MessageService.messageMaxLength) {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text('Message exceeds maximum length of ${MessageService.messageMaxLength} characters'),
  ...
  Widget build(BuildContext context) {
    ...
    final bool isNearLimit = _characterCount > MessageService.messageMaxLength * 0.8; // Over 80% of limit
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          Row(
            children: [
              ...
              IconButton(
                ...
                color: isAtLimit 
                    ? colorScheme.onSurfaceVariant.withAlpha(128) // Disabled color
                    : colorScheme.primary,
          ...
          Padding(
            padding: const EdgeInsets.only(left: 56.0, right: 16.0, bottom: 4.0),
            child: Row(
              ...
              children: [
                Text(
                  ...
                  style: TextStyle(
                    fontSize: 12,
                    color: isNearLimit
                        ? (isAtLimit ? colorScheme.error : colorScheme.error.withAlpha(200))
