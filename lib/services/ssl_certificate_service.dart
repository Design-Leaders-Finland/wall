...
class SSLCertificateService {
  static const String certificatePath = 'assets/certificates/supabase-prod-ca-2021.crt';
  ...
  static Future<void> configureCertificate() async {
    try {
      ...
      AppLogger.warning('Falling back to system SSL certificates. '
  ...
  static Future<bool> testSSLConnection(String url) async {
    try {
      ...
      AppLogger.info('SSL connection test: HTTPS=$isSecure, Status=$statusCode');
